...
const dijkstra = (graph, source, target) => {
    ...
    while (unvisitedVertices.length && !foundPath) {
        ...
        const unvisitedNeighbours = unvisitedVertices.filter((vertex) => graph[cheapestVertex][vertex] !== Infinity);
